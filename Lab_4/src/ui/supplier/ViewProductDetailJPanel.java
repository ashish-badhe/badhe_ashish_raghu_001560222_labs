...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product) {
        ...
        if(this.product.getProductImage() != null){
            productImg.setIcon(this.product.getProductImage());
        }else{
            productImg.setText("No Product Image");
        }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(productImg, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(productImg, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnSave)
                    .addComponent(btnUpdate)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Product Information Saved", "Information", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnRemoveFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveFeatureActionPerformed
        ...
        if(row < 0)  {
            JOptionPane.showMessageDialog(null, "Please select a feature from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(tblFeatures.getValueAt(row, 0) instanceof String){
            JOptionPane.showMessageDialog(null, "Please save all changes", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        Feature f = (Feature)tblFeatures.getValueAt(row, 0);
        product.removeFeature(f);
        refreshTable();
