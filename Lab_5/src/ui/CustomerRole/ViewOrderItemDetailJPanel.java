...
public class ViewOrderItemDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewOrderItemDetailJPanel(JPanel userProcessContainer, OrderItem item) {
        ...
        txtProductName.setText(this.item.getProduct().getProdName());
        txtProductId.setText(String.valueOf(this.item.getProduct().getModelNumber()));
        txtQuantity.setText(String.valueOf(this.item.getQuantity()));
        txtSalesPrice.setText(String.valueOf(this.item.getSalesPrice()));
        txtTotal.setText(String.valueOf(this.item.getSalesPrice() * this.item.getQuantity()));
    }
