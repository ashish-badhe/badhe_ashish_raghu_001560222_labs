...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblProductCatalog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Product Id", "Price", "Availabilty"
            }
        ) {
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Thank you for your purchase", "Information", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        int selectedRowIndex = tblCart.getSelectedRow();
        if(selectedRowIndex < 0){
            JOptionPane.showMessageDialog(this, "Please select the order", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRowIndex, 0);
        ViewOrderItemDetailJPanel vid = new ViewOrderItemDetailJPanel(userProcessContainer, item);
        userProcessContainer.add("ViewOrderItemDetail", vid);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please check price and quantity", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if(salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(this, "Price should be more than set price", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
